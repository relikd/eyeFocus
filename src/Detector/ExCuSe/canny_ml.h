...
#define MAX_LINE 10000 // maximal occuring line length
/*
Calculates the resulting edge image

input:
cv::Mat *strong -> strong edge values
cv::Mat *weak -> weak edge values
cv::Mat *check -> selected edges
...
/*
Start function of the matlab canny edge detector
